<%@ page import="com.bikerental.admin.model.Admin, com.bikerental.admin.util.FileHandler, java.util.List" %>
    ...
    <header>
        ...
        <div class="header-actions">
            <div class="search-box">
                <input type="text" placeholder="Search admins..." id="adminSearch">
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-header-flex">
                    ...
                    <div>
                        <a href="addAdmin.jsp" class="btn btn-sm btn-primary">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table" id="adminsTable">
                        ...
                        <tbody>
                        <%
                            List<Admin> admins = AdminManager.getAdmins();
                            if (admins != null) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="editAdmin.jsp?adminId=<%= admin.getAdminId() %>" class="btn btn-sm btn-warning" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="deleteAdmin" method="post" style="display:inline;">
                                    <input type="hidden" name="adminId" value="<%= admin.getAdminId() %>">
                                    <button type="submit" class="btn btn-sm btn-danger" title="Delete" onclick="return confirmDelete()">
...
<script>
    ...
    document.getElementById('adminSearch').addEventListener('input', function() {
        ...
        rows.forEach(row => {
            ...
            let rowText = '';
            cells.forEach(cell => {
                if (cell !== cells[cells.length - 1]) { // Skip actions column
